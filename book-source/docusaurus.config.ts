...
const config: Config = {
  ...
  url: 'https://syeda-hoorain-ali.github.io',
  ...
  organizationName: 'syeda-hoorain-ali', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Syeda Hoorain Ali, Inc. Built with Docusaurus.`,
    },
    prism: {
